...
local passes = {
	{key = "DoubleIncome", label = "2x INCOME", color = Color3.fromRGB(50, 200, 50), desc = "Double all earnings forever!"},
	{key = "AutoCollect", label = "AUTO-BUY", color = Color3.fromRGB(50, 150, 255), desc = "Auto-buy next business!"},
	{key = "VIP", label = "VIP ACCESS", color = Color3.fromRGB(255, 100, 100), desc = "3 exclusive VIP buildings!"},
	{key = "InsiderTrading", label = "INSIDER TRADING", color = Color3.fromRGB(50, 200, 150), desc = "See stock events early!"},
}
